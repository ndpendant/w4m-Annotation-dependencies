...
=head2 METHOD get_value_from_conf
	...
	## Description : permet de retourner une valeur du hash de conf à partir d'une key
	## Input : $oConf, $Key
	## Ouput : $Value
...
=head2 METHOD check_path_and_file
	...
	## Description : permet de vérifier les path et la présence des exe décrits dans le file conf. Bloque le script en cas de probleme
	## Input : $oConfs
	## Ouput : NA
